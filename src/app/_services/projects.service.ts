...
export class ProjectsService {
  ...
  projects: Project[] = [
    { id: 0, name: "Portfolio Angular ", pictures: ["../../assets/CV1.png", "../../assets/CV2.png", "../../assets/CV3.png"], projectLink: "//www.github.com", summary: "Un Portfolio réalisé en Angular, CSS et Bootstrap", description: "Un Portfolio réalisé en Angular, CSS et Bootstrap. Il utilise plus de 10 composants d'Angular et est reactif. ", tags: [Tag.ANGULAR] },
